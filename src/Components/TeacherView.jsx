...
const TeacherView = () => {
    ...
    const save = async (e) => {
        ...
        try {
            const response = await fetch("https://timesquare-backend.onrender.com/updateData", {
                method: "POST",
                headers: {
    ...
    const deleting = async () => {
        ...
        try {
            const response = await fetch("https://timesquare-backend.onrender.com/deletingTeacherData", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
